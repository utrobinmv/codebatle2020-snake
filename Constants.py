...
SHORE_WALL = -1000
SHORE_NEVER = -10000
NUM_SHORE_ENEMY_STEP = -200

SHORE_HOD = 0.5 #Вес одного хода
...
NUM_SHORE_TRAP_STEP = -80 #Какие очки преграды рассматриваются у ловушек, если подарок рядом не имеет проходов меньше очков, то очки не присуждаем, больше нуля нельзя, так как пустая клетка 0
